...
namespace EAPN.HDVS.Infrastructure.Configurations
{
    public class UsuarioConfiguration : IEntityTypeConfiguration<Usuario>
    {
        public void Configure(EntityTypeBuilder<Usuario> builder)
        {
            ...
            builder.HasData(
                new Usuario { Id = 1, Email = "Jjavierrg@gmail.com", Hash = "$2b$12$sn1hzFuoYJwKxocoCsn3me4gLtEeMG9sJrz/FQQu6XMww3bdoSgOe", IntentosLogin = 0, Activo = true },
                new Usuario { Id = 2, Email = "test@test.com", Hash = "$2b$12$vrDFckbZnoXbB9oFeLqqn.UQtnQ2UdYOJC/r6UqrjLfS00LagnO0q", IntentosLogin = 0, Activo = true }
            );
        }
    }
}
