...
namespace EAPN.HDVS.Web
{
	public class Startup
	{
		...
		private void ConfigureDataAccess(IServiceCollection services)
		{
			...
			services.AddDbContext<HDVSContext>(options => options.UseSqlite(Configuration.GetConnectionString("HDVSDatabase"), x => x.MigrationsAssembly(typeof(Startup).GetTypeInfo().Assembly.GetName().Name)));
		}
